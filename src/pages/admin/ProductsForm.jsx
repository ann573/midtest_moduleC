...
const ProductsForm = () => {
  ...
  return (
    <>
      <form
        className="max-w-[450px] mx-auto border mt-5 px-3"
      ...
      >
        ...
        <div className="mb-3 flex flex-col">
          ...
          <textarea
            name="description"
            id="description"
            className="resize-none border p-3"
            cols="30"
            rows="10"
        ...
        <button className="w-full bg-green-500 mb-3 py-2 rounded-md text-white font-bold">
          {id ? "Cập nhật" : "Thêm"}
        </button>
      </form>
    </>
